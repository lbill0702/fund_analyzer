...
with tab_div:
    if not all_divs:
        ...
        for fund in combined_div_all["Fund_Name"].unique():
            ...
            # Annualized Distribution Yield = latest monthly payment / NAV × 12
            # Each monthly distribution divided by NAV gives the monthly yield %;
            # multiplying by 12 annualizes it (expected range: 7.5–9%).
            ...
            with col2:
                ...
                st.markdown(
                    ...
                    f"<div class='label'>Ann. Distribution Yield</div>"
                    f"<div class='value' style='color:{color}'>{yield_str}</div>"
                    f"<div class='meta'><span style='color:var(--text3)'>{nav_str} · latest ÷ NAV × 12</span></div>"
                    f"</div>",
                    unsafe_allow_html=True,
                )
            with col3:
        ...
        with st.expander("Full Dividend History Table"):
            ...
            # Ann. Distribution Yield per row: each monthly payment ÷ NAV × 12
            # Shows what each distribution represents as an annualized % of unit price.
